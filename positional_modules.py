...
def str_slicer(row):
	...
	return position, native, mut_type #tried and failed as dict, tuple, list
...
### serious issues with unpacking to pandas df - laaaame
	stuff = ([str_slicer(row) for row in dfd.itertuples(False)])
	#dfd["pos1"], dfd["native1"], dfd["mut_type1"])
